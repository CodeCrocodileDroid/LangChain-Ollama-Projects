...
if docs:
    ...
    print("No documents loaded. Check the URL or internet connection.")

# Step 3: Create embeddings for the document chunks
# HuggingFaceEmbeddings turns text into numerical vectors (free, local)
...
if relevant_docs:
    ...
    print("The vector store might not have up-to-date information about new products.")